...
    rmp = &schedproc[proc_nr_n];
    ...
    /* MODIFICAÇÃO: Não rebaixar a prioridade. O processo será re-enfileirado
     * com a mesma prioridade para dar chance a outros de mesma prioridade.
     */
    /*
...
    /* Take over scheduling the process. */
...
    balance_timeout = BALANCE_TIMEOUT * sys_hz();
    ...
    /* MODIFICAÇÃO: Não precisamos do alarme se não vamos balancear as filas. */
...
    }
    ...
    /* MODIFICAÇÃO: Não re-agendar o alarme. */
    /*
    if ((r = sys_setalarm(balance_timeout, 0)) != OK)
        panic("sys_setalarm failed: %d", r);
    */
